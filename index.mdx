---
title: "Introduction"
description: "px0 is a local-first utility for building custom agents and workflows using natural language, then running them on a schedule. Everything it knows lives in plain Markdown files on your machine."
---
...
- **Tools** are how a workflow reaches outside px0. Every tool routes through Composio, and apps authorize themselves the first time a workflow needs one.
- **Guidelines** are your conventions, inlined verbatim into prompts so output comes back in your voice.
- **Knowledge** is the library of what you have read and kept, searchable and askable.
...
<CardGroup cols={2}>
  ...
  <Card title="Core concepts" icon="diagram-project" href="/get-started/concepts">
    The store, workflows, tools, guidelines, knowledge, and runs.
  </Card>
