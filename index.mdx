...
- **Ask** is the front door: `px0 ask` routes a question to whatever can answer it, and remembers what you correct.
...
- **Memory** is what px0 knows about you, accumulated from your corrections and carried into every run.
- **Brain** is the library of what you have read and kept, searchable and askable.
- **Runs** are the record of everything px0 did, so any output can be traced back to its inputs - and what px0 reads to say what is wrong with a workflow.
- **Approvals** hold anything that would speak in your name until you have read exactly what it says.
