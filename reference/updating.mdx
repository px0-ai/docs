...
It never deletes the store itself. `~/.px0` is a plain directory of Markdown and TOML — your guidelines, your library, your run history — so removing it is your call, and it is yours to back up or move somewhere else first:
