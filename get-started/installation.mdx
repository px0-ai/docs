...
- **Node.js 20 or newer**, only if you want the [qmd retrieval backend](/brain/retrieval).
...
This tears down any installed scheduler (launchd plist or systemd service) and removes the px0 binary via pipx / pip. By default, your store directory (`~/.px0`) and all your workflows, guidelines, brain, and history are preserved.

To remove your store data at the same time:
