...
<Note>
  You can also perform all of these actions (creating prompts, managing template versions, and promoting versions to live) directly through the user-friendly [px0 Web Console](http://localhost:8000). If you prefer configuring your prompt infrastructure programmatically using our API, you can follow the detailed step-by-step instructions below.
</Note>
